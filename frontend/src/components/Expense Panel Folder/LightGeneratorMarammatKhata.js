...
const LightGeneratorMarammatKhata = () => {
  ...
  const fetchRecords = async (filters = {}) => {
    ...
    let query = 'category=Light%20Generator%20Marammat%20Khata';
  ...
  return (
    <Container maxWidth="md">
      <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
        ...
        Light Generator Marammat Khata
        </Typography>
...
export default LightGeneratorMarammatKhata;
